...
public class MainActivity extends AppCompatActivity implements
    ...
    public void incrementWater(View view) {
        ...
        Intent incrementWaterCounIntent = new Intent(this, WaterReminderIntentService.class);
        incrementWaterCounIntent.setAction(ReminderTasks.ACTION_INCREMENT_WATER_COUNT);
        startService(incrementWaterCounIntent);
    }
